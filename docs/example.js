...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".wdu-form {\n  margin: 10px;\n  width: 100%;\n  border-radius: 8px;\n  border: 1px solid rgba(207, 207, 207, 0.6);\n  box-sizing: border-box;\n}\n.wdu-form-item {\n  width: 100%;\n  display: flex;\n  flex-flow: row wrap;\n  margin: 12px 0;\n  align-items: center;\n}\n.wdu-form-item .wdu-form-label {\n  min-width: 100px;\n  max-width: 100px;\n  text-align: right;\n  align-self: flex-start;\n  padding: 10px;\n  box-sizing: border-box;\n  font-size: 16px;\n  font-weight: 700;\n  color: #646464;\n}\n.wdu-form-handle {\n  border-top: 1px solid rgba(207, 207, 207, 0.6);\n  display: flex;\n  flex-direction: row;\n  flex-wrap: nowrap;\n  align-items: center;\n  justify-content: center;\n}\n", "",{"version":3,"sources":["webpack://./src/style/border.less","webpack://./src/components/Form/form.less","webpack://./src/style/layout.less","webpack://./src/style/font.less"],"names":[],"mappings":"AAAC;ECKG,YAAA;EACA,WAAA;EDDA,kBAAA;EAoBA,0CAAA;EEqCF,sBAAA;ADxDF;ADNC;ECaG,WAAA;EACA,aAAA;EACA,mBAAA;EACA,cAAA;EACA,mBAAA;AAJJ;ADbC;ECmBO,gBAAA;EACA,gBAAA;EACA,iBAAA;EACA,sBAAA;EACA,aAAA;ECuCN,sBAAA;EC3DA,eAAA;EACA,gBAAA;EACA,cAAA;AFmBF;ADxBC;EC8BG,8CAAA;ECNF,aAAA;EACA,mBAAA;EACA,iBAAA;EAKA,mBAAA;EAKA,uBAAA;ADJF","sourcesContent":[".w-radiu-small {\n    border-radius: 5px;\n}\n\n.w-radiu-normal {\n    border-radius: 8px;\n}\n\n.w-radiu-medium {\n    border-radius: 10px;\n}\n\n.w-radiu-large {\n    border-radius: 16px;\n}\n\n.w-border-solid {\n    border: 1px solid #dedede;\n}\n\n.w-border-circle {\n    border-radius: 50%;\n}\n\n.w-border-light{\n    border: 1px solid rgba(207, 207, 207, 0.6);\n}","@import (reference) '../../main.less';\n\n@t: wdu-form;\n\n.@{t}{\n    margin: 10px;\n    width: 100%;\n    .w-radiu-normal();\n    .w-border-light();\n    .w-box();\n}\n\n.@{t}-item{\n    width: 100%;\n    display: flex;\n    flex-flow: row wrap;\n    margin: 12px 0;\n    align-items: center;\n    .@{t}-label{\n        min-width: 100px;\n        max-width: 100px;\n        text-align: right;\n        align-self: flex-start;\n        padding: 10px;\n        .w-box();\n        .w-large-text();\n    }\n}\n\n.@{t}-handle{\n    border-top: 1px solid rgba(207, 207, 207, 0.6);\n    .center();\n}",".wdu-container {\n  display : flex;\n  flex-flow: row nowrap;\n  position: relative;\n}\n\n.wdu-aside {\n  position: relative;\n  left    : 0;\n  top     : 0;\n}\n\n.wdu-main {\n  position: relative;\n}\n\n.wdu-footer {\n  width: 100%;\n  left: 0;\n  bottom: 0;\n  flex-grow : 1;\n}\n\n.flex {\n  display       : flex;\n  flex-direction: row;\n  flex-wrap     : nowrap;\n}\n\n.row-col_center {\n  .flex();\n  align-items: center;\n}\n\n.center {\n  .row-col_center();\n  justify-content: center;\n}\n\n.row-around {\n  .flex();\n  justify-content: space-around;\n}\n\n.row-end {\n  .flex();\n  justify-content: flex-end;\n}\n\n.row-start {\n  .flex();\n  align-items    : center;\n  justify-content: flex-start;\n}\n\n.col-row_center {\n  .flex();\n  flex-direction : column;\n  justify-content: center;\n}\n\n.w-box {\n  box-sizing: border-box;\n}\n\n.hide-scroll {\n  &::-webkit-scrollbar {\n    display: none;\n  }\n\n  scrollbar-width: none;\n}","@import (reference) '../main.less';\n\n.w-large-text {\n  font-size  : 16px;\n  font-weight: 700;\n  color      : @font-color-descript;\n}\n\n.w-normal-text {\n  font-size  : 14px;\n  font-weight: 600;\n  color      : @font-color-descript;\n}\n\n.w-small-text {\n  font-size  : 12px;\n  font-weight: 700;\n  color      : @font-color-descript;\n}\n\n.w-title-text {\n  font-size  : 18px;\n  font-weight: bold;\n  color      : @font-color-main;\n  margin     : 0 8px;\n  .row-col_center();\n}\n\n.w-content-text {\n  font-size: 14px;\n  color    : @font-color-descript;\n  margin   : 0 8px;\n}\n\n.w-nowrap {\n  overflow     : hidden;\n  text-overflow: ellipsis;\n  white-space  : nowrap;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
